      ...
      <section>
        ...
        >
          <b-table-column field="userId" label="ID" v-slot="props" centered>
            <span class="tag is-info is-light">{{ props.row.userId }}</span>
          </b-table-column>
          <b-table-column field="level" label="君主" v-slot="props" centered>
            <span class="tag is-info is-light">{{ props.row.userName }}</span>
          </b-table-column>
          <b-table-column field="level" label="联盟" v-slot="props" centered>
            <span class="tag is-info is-light">{{ props.row.unionName }}</span>
          </b-table-column>
          <b-table-column
            field="addTime"
            label="更新时间"
          ...
          >
            <span class="tag is-success">
              {{ props.row.useTime | normalFormat }}
            </span>
          </b-table-column>
          <b-table-column
            field="level"
            ...
            centered
          >
            <span class="tag is-danger">{{ props.row.useNum }}</span>
          </b-table-column>
          <template #empty>
